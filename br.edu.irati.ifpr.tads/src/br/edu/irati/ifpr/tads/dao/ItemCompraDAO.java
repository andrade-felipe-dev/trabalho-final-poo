...
import java.util.List;
    ...
    public List<ItemCompra> buscarPorCompra(Compra compra) throws PersistenceException {
        try {
            PreparedStatement ps = this.con.prepareStatement("SELECT id, id_produto, id_compra FROM item_compras where id_compra = ?;");
